...
export type CloseInput<
  ...
  TAccountSwap extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountSwap>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountSwap> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.swap),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountSwap>;
