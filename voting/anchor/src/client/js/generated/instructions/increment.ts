...
export type IncrementInput<TAccountVoting extends string = string> = {
...
>(
  input: IncrementInput<TAccountVoting>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountVoting> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.voting)],
    programAddress,
    data: getIncrementInstructionDataEncoder().encode({}),
  } as IncrementInstruction<TProgramAddress, TAccountVoting>;
